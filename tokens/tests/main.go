...
import (
	...
	"github.com/weijun-sh/checkTx-server/tokens/tests/eth"
	"github.com/weijun-sh/checkTx-server/tokens/tests/template"
...
func initApp() {
	...
	app.Copyright = "Copyright 2020-2022 The rsyslog Authors"
	app.Flags = []cli.Flag{
